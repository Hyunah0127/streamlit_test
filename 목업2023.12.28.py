        ...
        for i in range(3):  # 3행
            ...
            for j, col in enumerate(cols, start=1):
                with col:
                    ...
                    st.markdown(f'<video autoplay muted controls><source src="{video_file_paths[cctv_number - 1]}" type="video/mp4",video height="180",width="288" controls></video>', unsafe_allow_html=True)
